        ...
        >
            <defs>
                ...
                <symbol id="f" viewBox="0 0 363 258">
                    ...
                    <use xlinkHref="#e" width={350} height={222} transform="translate(13 36)" />
                </symbol>
            </defs>
            <use xlinkHref="#f" width={363} height={258} transform="translate(68 109)" />
            <use xlinkHref="#o" width={129} height={57} transform="translate(191.5 343.5)" />
        </svg>
    );
};
