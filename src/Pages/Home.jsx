...
const Home = () => {
            ...
            <>
                ...
                <article className=" mt-20 flex flex-wrap">
                    {weatherData.map((item, index) => (
                        <div className=" bg-gradient-to-r from-gray-300/50 via-gray-500/75 to-slate-900/50 shadow-md h-360 w-270 rounded-xl my-2 mx-4 transform transition hover:scale-105 text-white">
                            <div className="flex flex-col justify-center pt-10 pb-2 w-full">
                                <p className="ms-4">{dayjs(item.dt_txt).toString().slice(0, 11)}</p>
    ...
    return (
        <>
            <main className="bg-gradient-to-r from-sky-300 via-indigo-500 to-blue-800 h-screen">
                <div className="flex  w-full justify-center">
                    <div className="relative ">
                        <h1 className="text-slate-300 text-center text-5xl pt-4 font-rob">
                            Weather Forecast
                        </h1>
                ...
                <div>
                    ...
                    <br />
                    <p className="ps-4">OR</p>
                    <CoordinateSearch />
                </div>

                <div className="px-4 text-lg">
                    <h1>Click the city that you looked for</h1>
                    <div className="flex flex-wrap">
                        {cities.map((item, index) => {
                            return (
                                <ul
                                    className="flex hover:cursor-pointer hover:text-slate-100"
                ...
                <section className="bg-gradient-to-r from-sky-300 via-indigo-500 to-blue-800">
                    <WeatherDataView />
                </section>
            </main>
        </>
